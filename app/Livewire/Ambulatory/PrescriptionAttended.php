...
class PrescriptionAttended extends Component implements HasTable, HasForms
{
    ...
    {
        return view('livewire.ambulatory.prescription-attended');
    }
    ...
    public function table(Table $table) : Table
    {
        return $table
            ...
            ->recordAction('prescription_make')
            ->filters([
